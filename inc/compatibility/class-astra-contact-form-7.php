...
if ( ! class_exists( 'Kanga_Contact_Form_7' ) ) :
	...
	class Kanga_Contact_Form_7 {
		...
		public function add_styles() {
			...
			$css_file = KANGA_THEME_URI . 'assets/css/' . $dir_name . '/compatibility/contact-form-7' . $file_prefix . '.css';

			wp_enqueue_style( 'kanga-contact-form-7', $css_file, array(), KANGA_THEME_VERSION, 'all' );
		}
