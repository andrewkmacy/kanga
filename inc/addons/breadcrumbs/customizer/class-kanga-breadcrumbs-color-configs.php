	...
	class Kanga_Breadcrumbs_Color_Configs extends Kanga_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'     => KANGA_THEME_SETTINGS . '[section-breadcrumb-color-divider]',
					'type'     => 'control',
					'control'  => 'ast-heading',
				 ...
				 */
				array(
					'name'      => KANGA_THEME_SETTINGS . '[section-breadcrumb-color]',
				...
				array(
					...
					'parent'     => KANGA_THEME_SETTINGS . '[section-breadcrumb-color]',
					'section'    => 'section-breadcrumb',
					'transport'  => 'postMessage',
					'tab'        => __( 'Normal', 'kanga' ),
